angular.module('mandelbrot', ['panzoom', 'panzoomwidget', 'angularSpinner'])
    ...
    .controller('PanzoomController', ['$scope', 'PanZoomService', 'usSpinnerService', function ($scope, PanZoomService, usSpinnerService) {
        $scope.model = {};
        $scope.config = {
            zoomLevels: 12,
            neutralZoomLevel: 5,
